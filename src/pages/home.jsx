...
export function Home() {
  return (
    <>
      <div className="relative flex h-screen content-center items-center justify-center pt-16 pb-32">
        ...
        <div className="max-w-8xl container relative mx-auto mt-10">
          <div className="flex flex-wrap items-center mt-10">
            <div className="ml-10 mr-auto w-full px-5  lg:w-8/12">
              <Typography
                variant="h1"
                color="white"
                className="mb-6 font-black"
              >
              CUSTOMIZED SOFTWARE SOLUTIONS FOR BUSINESS
              </Typography>
      ...
      <section className="mt-5 bg-white px-4 pb-20 pt-4">
        <div className="container mx-auto">
        <Typography
                variant="h3"
                color="red"
                className="mb-6 font-black text-center"
              >
             FEATURES
              </Typography>
          ...
          <div className="mt-32 flex flex-wrap items-center">
            <div className="mx-auto -mt-8 w-full px-4 md:w-5/12">
              <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-red-700 p-2 text-center shadow-lg">
              ...
              <Button variant="filled" className="bg-red-700">read more</Button>
            </div>
